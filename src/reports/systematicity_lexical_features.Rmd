...
We then calculated a **global correlation** score between the *form* and *meaning* distances of each wordpair. This results in a correlation of `r correlation$estimate` (p = `r correlation$p.value`)
